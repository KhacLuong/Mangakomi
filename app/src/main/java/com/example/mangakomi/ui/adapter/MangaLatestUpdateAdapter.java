...
public class MangaLatestUpdateAdapter  extends RecyclerView.Adapter<MangaLatestUpdateAdapter.MangaLatestUpdateViewHolder>{
    private  List<MangaLatest> mangaList;
    public final IOnClickMangaItemListener iOnClickMangaItemListener;

    public void setData(List<MangaLatest> listData) {
        this.mangaList = listData;
    }

    public MangaLatestUpdateAdapter(List<MangaLatest> mangaList, IOnClickMangaItemListener iOnClickMangaItemListener) {
    ...
    @NonNull
    @Override
    public MangaLatestUpdateViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemLatestUpdateBinding itemLatestUpdateBinding = ItemLatestUpdateBinding
                .inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new MangaLatestUpdateViewHolder(itemLatestUpdateBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull MangaLatestUpdateViewHolder holder, int position) {
        try {
    ...
    public static class  MangaLatestUpdateViewHolder extends RecyclerView.ViewHolder{
        private final ItemLatestUpdateBinding itemLatestUpdateBinding;
        public MangaLatestUpdateViewHolder(ItemLatestUpdateBinding itemLatestUpdateBinding) {
