...
public class MangaSearchAdapter extends RecyclerView.Adapter<MangaSearchAdapter.MangaDetailViewHolder>{
    private  List<MangaLatest> mangaList;
    public  IOnClickMangaItemListener iOnClickMangaItemListener;

    public MangaSearchAdapter(List<MangaLatest> mangaList, IOnClickMangaItemListener iOnClickMangaItemListener) {
    ...
    @NonNull
    @Override
    public MangaDetailViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemLatestUpdateBinding itemLatestUpdateBinding = ItemLatestUpdateBinding
                .inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new MangaDetailViewHolder(itemLatestUpdateBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull MangaDetailViewHolder holder, int position) {
        try{
...
//        xu ly danh gia sao
    ...
    public static class  MangaDetailViewHolder extends RecyclerView.ViewHolder{
        private final ItemLatestUpdateBinding itemLatestUpdateBinding;
        public MangaDetailViewHolder(ItemLatestUpdateBinding itemLatestUpdateBinding) {
