...
public class MangaHotAdapter extends RecyclerView.Adapter<MangaHotAdapter.MangaHotViewHolder>{
    ...
    public MangaHotAdapter(List<MangaLatest> mangaList, IOnClickMangaItemListener iOnClickMangaItemListener) {
        this.mangaList = mangaList;
    ...
    @NonNull
    @Override
    public MangaHotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemLatestUpdateBinding itemLatestUpdateBinding = ItemLatestUpdateBinding
                .inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new MangaHotViewHolder(itemLatestUpdateBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull MangaHotViewHolder holder, int position) {
        try{
            ...
            holder.itemLatestUpdateBinding.tvNameManga.setMinLines(2);
    ...
    public static class  MangaHotViewHolder extends RecyclerView.ViewHolder{
        private final ItemLatestUpdateBinding itemLatestUpdateBinding;
        public MangaHotViewHolder(ItemLatestUpdateBinding itemLatestUpdateBinding) {
