...
public class MangaLatest implements Serializable {
    ...
    public MangaLatest(String link_manga, String title_manga, String poster_manga, String rating_manga, String lastest_chapter_manga, String release_date_manga) {
